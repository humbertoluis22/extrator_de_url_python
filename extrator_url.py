...
class ExtratorURL:
    ...
    def get_valor_parametro(self,parametro_buca):

        indice_parametro = self.get_url_parametros().find(parametro_buca)
    ...
    def __str__(self):
        return self.url + "\n" + "parametros da url: " + self.get_url_parametros() + '/n' + "url base:"+ self.get_url_base()

    def __eq__(self, other):
        return self.url == other.url

#bytebank.com/quantidade=100&moedaOrigem=real&moedaDestino=dolar
